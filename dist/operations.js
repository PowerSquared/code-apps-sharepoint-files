 ...
 */
const CONNECTION = { name: 'connectionId', in: 'path', required: true, type: 'string' };
const DATASET = { name: 'dataset', in: 'path', required: true, type: 'string' };
const FILE_ID = { name: 'id', in: 'path', required: true, type: 'string' };
/**
